...
<head>
    ...
    <title>Verify Your Email - PDF Editor</title>
</head>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center; color: white;">
                            ...
                            <p style="font-size: 16px; opacity: 0.9; margin: 0;">Verify Your Account</p>
                        </td>
                    </tr>
                    <!-- Content -->
                    <tr>
                        <td style="padding: 40px 30px; text-align: center;">
                            ...
                            <p style="font-size: 16px; color: #4a5568; line-height: 1.6; margin-bottom: 30px; margin: 0;">
                                Welcome to PDF Editor! To get started, please verify your email address by clicking the button below.
                            </p>
                            <a href="{{ $url }}" style="display: inline-block; padding: 15px 30px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.3);">Verify Email Address</a>
                        </td>
                    </tr>
                    <!-- Footer -->
                    <tr>
